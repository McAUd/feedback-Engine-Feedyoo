...
<body>
    <section class="masthead">
        <header id="header" class="header">
            <div class="container flex header-menu">
                ...
                <nav>
                    <ul>
                        <li><a class="nav-link" href="index">feedyoo</a></li>
                        <li><a class="nav-link" href="#about">About</a></li>
                            <li>
                            <a class="nav-link" href="app/register">Sign Up</a>
                        </li>
                    </ul>
                </nav>
    ...
    <div class="form-container">
        <p style="color: #000;"><strong>Search for the username of the account you want to give feedback to</strong></p>
        <form class="app-search" action="home.php" method="GET">
    ...
    if (isset($_GET['username'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                // Output the retrieved username information with styling
                echo "<p class='user-info'>User found: <a href='fprofile?username=" . urlencode($row['username']) . "'>" . htmlspecialchars($row['username']) . "</a></p>";
            
                // ... display other relevant information
            }
        } else {
            // Output message if no user found
            echo "<p class='no-user'>No user found with the username: <strong>" . htmlspecialchars($username) . "</strong></p>";
        }
